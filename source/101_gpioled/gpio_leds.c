   ...
   */
   ...
   // reset FSEL to 000 before set to 001
	...
	for(int i = 0; i < 3; i ++) {
      ...
      gpio[GPCLR0/4] |= (0x1 << (LED0 % 32));
      gpio[GPCLR0/4] |= (0x1 << (LED1 % 32));
      gpio[GPCLR0/4] |= (0x1 << (LED2 % 32));
      gpio[GPCLR0/4] |= (0x1 << (LED3 % 32));
      sleep(1);

      // Turn off LED (active-LOW)
      gpio[GPSET0/4] |= (0x1 << (LED0 % 32));
      gpio[GPSET0/4] |= (0x1 << (LED1 % 32));
      gpio[GPSET0/4] |= (0x1 << (LED2 % 32));
      gpio[GPSET0/4] |= (0x1 << (LED3 % 32));
      sleep(1);
	}
